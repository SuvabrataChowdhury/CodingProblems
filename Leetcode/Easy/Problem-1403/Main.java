...
Question:
	...
	Example 2:
		...
		equal to 14 which is not strictly greater than the sum of elements
		not included (14 = 4 + 4 + 6). Therefore, the subsequence [7,6,7] is
		the minimal satisfying the conditions. Note the subsequence has to be returned in non-decreasing order.  
...
class Main{
	public static void main(String[] args){
		...
		int[] nums={4,3,10,9,8};
		System.out.println(ob.minSubsequence(nums).toString());
	}
}
