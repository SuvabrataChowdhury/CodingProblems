/*
	Question:
		...
		will put in $1 more than the day before. On every subsequent Monday, he will put in $1 more than the previous Monday.
...
class Solution{
	public int totalMoney(int n){
		...
		return (28*noWeeks + (7 * (noWeeks-1) * noWeeks/2)) + ((daysRemaining * (daysRemaining+1)/2) + (daysRemaining * noWeeks)) ;
	}
}
...
class Main{
	public static void main(String[] args){
		...
		System.out.println(ob.totalMoney(Integer.parseInt(args[0])));
	}
}
