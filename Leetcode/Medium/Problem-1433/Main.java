/*
	Question:
		...
		Example 2:
			...
			Input: s1 = "abe", s2 = "acd"
			Output: false 
			Explanation: All permutations for s1="abe" are: 
			"abe", "aeb", "bae", "bea", "eab" and "eba" and 
			all permutation for s2="acd" are:
			"acd", "adc", "cad", "cda", "dac" and "dca".
...
class Solution{
	public boolean checkIfCanBreak(String s1, String s2){
		...
		return isDominent(string1,string2) || isDominent(string2,string1);
	}

	public boolean isDominent(char[] string1,char[] string2){
...
class Main{
	public static void main(String[] args){
		...
		System.out.println(ob.checkIfCanBreak(args[0],args[1]));
	}
}
